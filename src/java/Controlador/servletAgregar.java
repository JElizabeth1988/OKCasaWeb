...
public class servletAgregar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String hipotecario = "No";
        int id_comuna = Integer.parseInt(request.getParameter("cboComuna"));

        Cliente cli = new Cliente(rut_cliente, primer_nombre, segundo_nombre, ap_paterno, ap_materno, direccion, telefono, email, hipotecario, id_comuna);
