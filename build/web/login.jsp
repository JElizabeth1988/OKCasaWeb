                ...
                <div class="col-md-5">
                    <form role="form" method="POST" action="login.html">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input type="text" name="seg_nombre" id="username" class="form-control input-lg" placeholder="Segundo Nombre"
                                       >
                            </div>
                            <div class="form-group">
                                <input type="text" name="apellido_paterno" id="username" class="form-control input-lg" placeholder="Apellido Paterno"
                                       title="Debe ingresar su apellido paterno" required minlength="5">
                            </div>
                            <div class="form-group">
                                <input type="text" name="apellido_materno" id="username" class="form-control input-lg" placeholder="Apellido Materno"
                                       title="Debe ingresar su pellido materno" required minlength="5">
                            </div>
                            <div class="form-group">
