...
<html>
    ...
    <body style="background-color: white;">
                ...
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        ...
                        <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home <i
                                        class="ion-ios-arrow-forward"></i></a></span> <span>Eliminar <i class="ion-ios-arrow-forward"></i></span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <h2 class="text-center" id="title">Eliminar Cliente</h2>
            <p class="text-center">
                                ...
                                <div class="col-md">   
                                    ...
                                    <div class="form-check" style="text-align: center;">
                                        ...
                                        <div class="justify-content-center">
                                            ...
                                            <input type="submit" class="btn btn btn-primary" style="margin-right: 40px" value="Eliminar Cliente">
                                        </div>
                                    </div>
