<%-- 
    Document   : Pago
    Created on : 17-06-2020, 17:05:45
    Author     : chida
--%>
                    ...
                    <div class="wrap-contact100">
                        ...
                        <form action="servletPago" method="POST">
                            <fieldset>
                                <br>
                                <div class="row justify-content-center">
                                    <label style="font-family: fantasy; font-size: 22px;color: #black; font-weight: bold;">Transacción</label>

                                </div>
                                <br>
                                <label for="total" class="control-label" id="lab" style="font-size: 15px;">Ingrese monto a pagar</label>
                                <div class="input-group form-group" id="tx" style="margin-left: 50px; background-color: #34c0e7">
                                    <input class="form-control" type="text" name="txtTotal" id="username"  placeholder="$" class="form-control input-lg"
                                           title="Debe Ingresar el Total" required minlength="5">

                                </div>

                                <label for="pago" class="control-label" id="lab" style="font-size: 15px;">Ingrese Pago</label>
                                <div class="input-group form-group" id="tx" style="margin-left: 50px">

                                    <input type="text" name="txtPago" id="password" placeholder="$" class="form-control input-lg"
                                           title="Debe Ingresar su Pago" required minlength="5">

                                </div>

                                <div>
                                    <input type="submit" class="btn btn btn-danger" value="Realizar Pago" style="margin-left: 50px; width: 75%;">
                                </div>
                                <br>
                                <br>
